...
function renderActions(r){
  ...
  const targetInfo=$('targetInfo'),targetDistance=target&&me?distanceToEnemy(me,target):null;
  if(target){
...
function syncHudContextV148(r,activeHunter){
  ...
  if(mode==='run'){setHudPanelV141('party',true);setHudPanelV141('intel',false)}
  else if(mode==='world'){setHudPanelV141('party',false);setHudPanelV141('intel',true)}
  else if(mode==='camp'){setHudPanelV141('party',true);setHudPanelV141('intel',false)}
}
