...
Treat this repository as the canonical ASHFALL game client/source. Do not rebuild the game from scratch. Preserve existing saves, classes, Hunter's Ascent, Huntforged crafting, Deep Hunts, Delves, bosses, camp systems, equipment slots, art, and progression unless explicitly changing them. The current private ChatGPT Site shell and D1 relay implementation are not yet versioned here; cross-browser hosting is therefore not reproducible from this repository alone.
